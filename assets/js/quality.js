...
var DocQuality = (function () {
  ...
  var LIMITS = {
    ...
    glarePct:        4.5,    // אחוז פיקסלים "שרופים" - ברק או השתקפות
  ...
  function judge(m) {
    ...
    } else if (m.mean > LIMITS.bright) {
      flag('poor', 'התמונה בהירה מדי',
        'התרחקו מאור ישיר או כבו את הפלאש.');
    }
    ...
    if (m.glarePct > LIMITS.glarePct) {
      flag('poor', 'יש ברק או השתקפות על המסמך',
        'כבו את הפלאש, וזוזו הצידה כך שהאור לא ייפול ישירות על הדף.');
    }
